...
impl<B: Backend> Default for Model<B> {
    fn default() -> Self {
        let url = "https://github.com/uw-loci/cellcast/raw/refs/tags/cellcast-v0.2.0/weights/stardist/stardist_2d_versatile_he.bpk";
        let file_name = "stardist_2d_versatile_he.bpk";
